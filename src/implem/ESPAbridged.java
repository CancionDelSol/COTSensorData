 ...
 */
public class ESPAbridged extends ConfigurableBase {
    //region Constants
    ...
    //region Fields
    private static ESPAbridged _singleton = new ESPAbridged();
     ...
     */
    private ESPAbridged() {
        super(Globals.ESP_ABRIDGED_MODULE_CONFIG_FILE);
